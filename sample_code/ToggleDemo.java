...
class ButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
	String newText = ToggleDemo.getMsg().getText();
	System.out.println("New text = " + newText);
	if (newText.equals("Bluebird")) {
	    System.out.println("Is bluebird");
	    newText = "Monorail!";
	} else {
	    System.out.println("Is something else..");
	    newText = "Bluebird";
	}
	ToggleDemo.getMsg().setText(newText);
	ToggleDemo.getFrame().setVisible(true);
    }
